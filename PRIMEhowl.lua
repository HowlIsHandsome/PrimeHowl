...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart", "RightUpperLeg", "LeftUpperLeg", "RightUpperArm", "LeftUpperArm", "RightLowerArm", "LeftLowerArm", "RightHand", "LeftHand","LeftFoot", "RightFoot","RightHand", "LeftHand",}
